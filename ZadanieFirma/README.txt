...
Wysokość pensji wyznaczana jest dla każdego z tych kontraktów inaczej, odpowiednio:
...
wysokości pensji. 
* Za obliczanie pensji odpowiedzialny jest obiekt klasy kontrakt, 
który 
* udostępnia metodę publiczną zwracającą wysokość wynagrodzenia za pomocą metody Pensja(). 
